...
function JoinDesigner() {
  return (
    <Layout styles="h-fit relative">
     ...
     <div className='flex flex-col lg:flex-row items-center gap-8 min-w-0 lg:min-w-[915px] max-w-[1200px] px-16 h-full py-16 lgc:w-[85%] mx-auto'>
      <Image alt='' src='https://assets.website-files.com/5b60dd35a56ec7bab0703d2d/5c86db21b4d0ca56dee6a263_sddd_lockup_reverse.svg' width={120} height={102.52}/>
    <div className='flex flex-col h-full lgc:pl-24 justify-center items-start'>
